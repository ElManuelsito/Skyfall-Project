...
class Paladin(Character):
    def __init__(self, name):
        super().__init__(name, health=200, max_health=200, armor=40, mana=25, max_mana=25, str=10, agi=4, int=20, faith=11, acc=8, res_magic=10,
                         res_phys=10, money=0, lvl=0, exp=0, armor_items_on=0, weapon_items_on=0)

    def attackWithSkillA(self):  # Sentencia
        return True
